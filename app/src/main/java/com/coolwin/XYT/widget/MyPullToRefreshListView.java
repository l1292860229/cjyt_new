...
public class MyPullToRefreshListView extends LinearLayout {
	...
	private TextView mRefreshViewText,moreViewText;
	private RotateAnimation mReverseFlipAnimation;
	private boolean mScrollingList = false;
	private int mState;
	private ProgressBar mRefreshProgress,moreProgress;
	...
	private void updateRefreshView(int height) {
		Log.e("updateRefreshView","height="+height);
		if (height <= 0) {
			return;
		}
