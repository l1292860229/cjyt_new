...
import com.coolwin.XYT.adapter.RoomAdapter;
...
import com.coolwin.XYT.widget.SearchDialog;
...
//			mGroupCount.setVisibility(View.GONE);
		...
		mTitleLayout.measure(w, h);
		RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(mListView.getLayoutParams());
		layoutParams.setMargins(0,mTitleLayout.getMeasuredHeight(),0,0);
