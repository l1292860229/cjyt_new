...
public class IMCommon {
	...
	private static IMInfo mIMInfo = new IMInfo();
	...
	public static final String FIRSTOPEN2 = "firstopen2";
	...
	public static boolean getNetWorkState(){
		Log.e("getNetWorkState","mIsNetWorkAvailable="+mIsNetWorkAvailable);
	...
	public static void saveNewFriendsResult(Context context, List<NewFriendItem> list, int count){
		...
		//SharedPreferences存储数据,实际上SharedPreferences处理的就是一个key-value
	...
	public static void setPhone(String phone){mPhone = phone;}
