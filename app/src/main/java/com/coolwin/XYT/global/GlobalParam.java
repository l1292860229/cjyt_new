...
public class GlobalParam {
	...
	/** 通过广播刷新会议数据 *//*
	public static final String ACTION_UPDATE_MEETING_SESSION_COUNT = "com.wqdsoft.im.intent.action.update.meeting.session.count";
*/
	...
	public final static String ACTION_SHOW_REGISTER_REQUEST = "com.wqdsoft.im.intent.register.request";
	public final static String SWITCH_TAB = "im_switch_tab";
	public final static String CANCLE_COMPLETE_USERINFO_ACTION = "com.wqdsoft.im.cancle.complete.userinfo";
	...
	public final static String HID_MESSAGE_COUNT = "im_hid_message_count";
	...
	public final static String ACTION_LINKE_WEIBO = "im_action_linke_weibo";
	...
	public final static int LIST_LOAD_UPDATE = 504;
	...
	public final static int MSG_GET_TYPE_DATA = 1001;
