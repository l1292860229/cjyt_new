...
public class XmppManager {
	...
	public static final String XMPP_RESOURCE_NAME =HOST; //"ay130624211425z";
	//public static final String  c = "6237fba915bc4db";
		...
		public void run() {
			...
			if (!xmppManager.isAuthenticated()) {
				...
				ConnectionConfiguration connConfig = new ConnectionConfiguration(
						HOST, PORT);
				connConfig.setSecurityMode(ConnectionConfiguration.SecurityMode.disabled);//设置为disabled
