...
import com.coolwin.XYT.receiver.ConnectivityReceiver;
import com.coolwin.XYT.receiver.NotificationReceiver;
import com.coolwin.XYT.receiver.PhoneStateChangeListener;
...
public class SnsService extends Service {
	...
	public void onCreate() {
		...
		userInfoVo = IMCommon.getLoginResult(BMapApiApp.getInstance());
		try {
			//登录xmpp服务器
			xmppManager = new XmppManager(this, String.valueOf(userInfoVo.phone), userInfoVo.openfirePwd);
		} catch (Exception e) {
    ...
    public class TaskSubmitter {
        ...
        final com.coolwin.XYT.service.SnsService SnsService;

        public TaskSubmitter(com.coolwin.XYT.service.SnsService SnsService) {
    ...
    public class TaskTracker {
        ...
        public TaskTracker(com.coolwin.XYT.service.SnsService SnsService) {
            this.SnsService = SnsService;
            this.count = 0;
        }
