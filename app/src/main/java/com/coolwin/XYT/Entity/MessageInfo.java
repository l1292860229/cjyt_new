...
public class MessageInfo extends SNSMessage {
	...
	public String redpacket;//红包
	public String redpacketTitle;//红包标题
	public String redpacketUrl;//红包地址
	...
	public MessageInfo (JSONObject json){
		try {
			...
			if(!json.isNull("redpacket")){
				String redpacketString  = json.getString("redpacket");
				if(redpacketString!=null && !redpacketString.equals("") && redpacketString.startsWith("{")){
					redpacket = redpacketString;
					JSONObject redpacketObject = json.getJSONObject("redpacket");
					redpacketTitle = redpacketObject.getString("redpackettitle");
					redpacketUrl =  redpacketObject.getString("redpacketurl");
				}
			}
	...
	public String toString() {
		return "MessageInfo{" +
				...
				", systeMessage=" + systeMessage +
				", cardOwerName='" + cardOwerName + '\'' +
