...
public class AddInformationPresenter extends BasePresenter<UIAddInformation> {
    ...
    public AddInformationPresenter(){
        servlet = retrofit.create(AddCommodityServlet.class);
    }
    public void upload(String commodityTitle,String commodityPrice,String commodityDescription,String type,
        ...
        mView.showLoading();
        servlet.savecommodity(UrlConstants.BASEURL2+"saveinformation",
                ...
                getMultipartRequestBodyPart(type),
