...
mTabHost.addTab(TAB_TAG_1, "Hello, world!", "Tab 1");
    ...
    public void addTab(TabSpec tabSpec) {
        ...
        //ThemeHelper.setWidgetTheme(getContext(), tabIndicator, ThemeHelper.RES_NAME_TAB_INDICATOR);
    ...
    public void setCount(int i, int count){
    	if(mTabWidget.getChildCount() >= i){
    		TextView tv = (TextView) mTabWidget.getChildAt(i).findViewById(R.id.count);
