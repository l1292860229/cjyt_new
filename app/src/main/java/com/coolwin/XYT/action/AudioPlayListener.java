package com.coolwin.XYT.action;
...
public class AudioPlayListener implements OnClickListener {
	...
	public void setTingTong(boolean isTingTong){
		this.isTingTong = isTingTong;
	}
	...
	public void onClick(View v) {
		if(v.getTag() instanceof MessageInfo){
			MessageInfo msg = (MessageInfo) v.getTag();
			playVideo(msg,v);
		}else if(v.getTag() instanceof BbsReplyInfo){
			BbsReplyInfo msg = (BbsReplyInfo) v.getTag();
			playVideo(msg,v);
		}

	}
	public void playVideo(MessageInfo msg, View v){
		if(msg == null){
			return;
		}
	...
	public void playVideo(BbsReplyInfo msg, View v){
		if(msg == null){
			return;
		}
		if(mAudioPlay.getCurrentUrl().equals(msg.voiceUrl) && mAudioPlay.getPlayState()){
		...
		Log.e("AudioPlayListener", "onClick");
		mAudioPlay.setMessageTag(msg.id);
		this.playStatus.setBtn((RelativeLayout)v);
		this.playStatus.playing();
	...
	public void play(BbsReplyInfo messageInfo){
		Log.e("AudioPlayListener", "play");
		mAudioPlay.setMessageTag(messageInfo.id);
		mAudioPlay.play(messageInfo, 1, true);
	}
