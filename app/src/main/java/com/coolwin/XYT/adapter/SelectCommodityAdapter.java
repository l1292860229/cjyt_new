...
public class SelectCommodityAdapter extends BaseAdapter<MyCommodity>{
    public List<MyCommodity> checkedSubjects = new ArrayList<>();
    public SelectCommodityAdapter(Context context, List<MyCommodity> mList) {
        super(context);
        this.mList = mList;
    }
    public List<MyCommodity> getCheckedSubjects() {
    ...
    public void onBindViewHolder(final MyRecycleViewHolder holder, final int position) {
        final MyCommodity subjects =  mList.get(position);
        ...
        for (MyCommodity checkedSubject : checkedSubjects) {
